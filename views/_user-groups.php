...
if(isset($_GET['create_user_group']) && $_GET['create_user_group'] != "") {
  ...
  wp_redirect('./admin.php?page=project');
...
function createUserGroup() {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      //console.log(result);
      window.location.href = `./admin.php?page=project&create_user_group=${result.value}`;
    }
  })
}
...
function deleteUserGroup(role) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      window.location.href = `./admin.php?page=project&delete_user_group=${role}`;
